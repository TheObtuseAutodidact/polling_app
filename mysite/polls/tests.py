...
def create_question(question_text, days):
    """
    Creates a qustion with the given 'question_text' and
    published the given number of 'days' offset to now
    (negative for question published in the past, positive
    or questions that have yet to be published).
    """
...
class QuestionViewTests(TestCase):
    def test_index_view_with_no_questions(self):
        """
        If no question exist, an appropirate message
        should be displayed.
        """
